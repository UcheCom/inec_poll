...
export default function EditPollForm({ pollId, initialData }: EditPollFormProps) {
    ...
    // Load poll data if not provided
    useEffect(() => {
        if (!initialData && pollId) {
            const loadPoll = async () => {
                ...
                if (result.success && result.poll) {
                    ...
                    setFormData({
                        ...
                        election_type: poll.election_type as ElectionType,
                        state: poll.state || '',
                        lga: poll.lga || '',
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        const result = await updatePoll(pollId, submitData, user.id)
        ...
        <div className="max-w-2xl mx-auto p-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                {success && (
                    <div className="bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded">
                        <div className="flex items-center">
                            ...
                            <div>
                                <p className="font-semibold">Poll updated successfully!</p>
                ...
                <div className="flex justify-end space-x-4">
                    ...
                    >
                        {isSubmitting ? 'Updating...' : success ? 'Poll Updated!' : 'Update Poll'}
                    </button>
                </div>
            </form>
        </div>
